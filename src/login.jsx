...
export default function Login({ connected, connectionState, onLogin, error }) {
	...
	return <div className="login-page"><form className="login-card" onSubmit={submit}>
		...
		<label className="login-remember"><input type="checkbox" checked={remember} onChange={event => setRemember(event.currentTarget.checked)} /> Remember me on this device</label>
